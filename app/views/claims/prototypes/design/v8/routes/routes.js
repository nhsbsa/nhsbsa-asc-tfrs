...
const { checkClaim, compareNINumbers, sortByCreatedDate, generateUniqueID, validateDate, checkDuplicateClaim, checkLearnerForm, loadJSONFromFile } = require('../helpers/helpers.js');
...
function loadData(req) {
  ...
  const path = 'app/views/claims/prototypes/design/v8/data/'
