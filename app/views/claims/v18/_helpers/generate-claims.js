...
function generateSubmissions(users, status, policyDate, trainingItem, backOfficeStaff, claimType, createdDate, isPaymentPlan) {
  ...
  const learners = JSON.parse(fs.readFileSync('./app/views/claims/v18/_data/learners.json', 'utf8'));
...
function generateClaims(workplaceID) {
  ...
  // Load JSON files
  const training = JSON.parse(fs.readFileSync('./app/views/claims/v18/_data/training.json', 'utf8'));
  const statuses = JSON.parse(fs.readFileSync('./app/views/claims/v18/_data/claim-statuses.json', 'utf8'));
  const organisations = JSON.parse(fs.readFileSync('./app/views/claims/v18/_data/organisations.json', 'utf8'));
  const backOfficeStaff = JSON.parse(fs.readFileSync('./app/views/claims/v18/_data/backOfficeStaff.json', 'utf8'));
